...
namespace Tasky.Shared
{
	...
	public class TodoDatabase 
	{
		...
		TodoItem FromReader (SqliteDataReader r) {
			...
			toDoEntity.ID = Convert.ToInt32 (r ["_id"]);
			toDoEntity.Name = r ["Name"].ToString ();
			toDoEntity.Notes = r ["Notes"].ToString ();
			toDoEntity.Done = Convert.ToInt32 (r ["Done"]) == 1 ? true : false;
			return toDoEntity;
		}
